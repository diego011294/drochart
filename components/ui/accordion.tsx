...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <div className="bg-white/10 px-2 py-2 rounded-full border-white/20 border transition-transform duration-200
     group-data-[state=open]:rotate-180">
        <ChevronDownIcon className="text-muted-foreground text-white pointer-events-none size-4 shrink-0 translate-y-0.5" />
        </div>
      </AccordionPrimitive.Trigger>

        ...
        brands={[
          {
            ...
            description: [
              "DOBLEUVE Artesanía es una marca gallega de joyería artesanal fundada en 2021, centrada en la creación de pendientes únicos en arcilla polimérica.",
              "El sistema visual se construye a partir del juego con formas orgánicas de arcilla, que dan lugar a una composición central donde conviven los tres colores característicos de la marca, aportando equilibrio, personalidad y coherencia gráfica.",
            ],
          ...
          },
          {
            ...
            description: [
              "Domubox es una empresa distribuidora de casas modulares, especializada en ofrecer soluciones de vivienda eficientes, modernas y adaptables.",
              "El logo refleja la idea de simplicidad y modularidad. Sus formas geométricas representan la estructura de una casa tipo 'caja', haciendo referencia directa al concepto de construcción modular. La identidad busca transmitir orden, funcionalidad y modernidad, valores clave de la marca.",
            ],
          ...
          },
          {
            ...
            description: [
              "Diseño de identidad visual y creación de personaje para una escudería de rally en Galicia. El proyecto se desarrolló con el objetivo de crear una marca reconocible, dinámica y adaptable tanto a merchandising como a rotulación de competición.",
              "El logotipo combina un enfoque 'character design' con estética racing, utilizando un pistón antropomórfico como elemento principal para transmitir personalidad, cercanía y pasión por el motor. La identidad fue pensada para funcionar en diferentes soportes como camisetas, pegatinas y decoración de carrocería, manteniendo siempre un estilo agresivo, divertido y fácilmente reconocible dentro del entorno del rally.",
            ],
